...
window.App = {
    ...
    addWill: function (form)
    {
        ...
        var time = form.dropdownMenu1.value
        ...
        WillContract.deployed().then(function(instance) {
            return instance.makeWill(address, time, { value: web3.toWei(value,'ether'), from: web3.eth.coinbase, gas: 2000000, gasPrice: 200000000000 });
        }).then(function(txid){
